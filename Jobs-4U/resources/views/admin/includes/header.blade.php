            ...
            <li class="nav-item dropdown pe-3">
                ...
                <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                    <div class="image-div dropdown-toggle me-4 rounded-circle" style="width: 35px; height:35px;">
                        <img style="width: 100%; height:100%; object-fit:cover;" src="{{ asset(Auth::user()->profile_pic ? "storage/" . Auth::user()->profile_pic : "img/demo_image.png") }}" class="rounded-circle" alt="">
                    </div>
                </a>
                {{--  End Profile pic --}}
